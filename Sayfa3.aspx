<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sayfa3.aspx.cs" Inherits="aspxliDeneme.Sayfa3" %>

<!DOCTYPE html>
<!-- saved from url=(0070)file:///C:/Users/safiy/Masa%C3%BCst%C3%BC/NiceAdmin/users-profile.html -->
<html lang="en"><head>
...
<body>
    <form runat="server">
        ...
        height="30" runat="server"></asp:ImageMap>   
            ...
            <div class="pagetitle">
                ...
                <asp:Button ID="Button1" class="nav-link active" style="border:none; background-color: #f6f9ff;" runat="server" Text="home" /></li>
            ...
            <section class="section profile">
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <div class="card" style="width: 390px; height: 260px;">
        ...
        width="100" 
        height="100" runat="server"></asp:ImageMap>  
                                <h2><asp:Label ID="isim" runat="server" Text="Label"></asp:Label></h2>
                                <h3><asp:Label ID="meslek" runat="server" Text="Label"></asp:Label></h3>
  ...
  <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                            ...
                            <div class="card-body pt-3">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <asp:Button ID="buton" CssClass="buton"  style="width:150px;" data-bs-toggle="tab" data-bs-target="#profile-change-password" aria-selected="true" role="tab" runat="server" Text="Change Password" />
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade pt-3 active show" id="profile-change-password" role="tabpanel">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <asp:TextBox runat="server" CssClass="textboxlar" id="mevcutSifre"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <asp:TextBox runat="server" CssClass="textboxlar" id="yeniSifre1"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <asp:TextBox runat="server" CssClass="textboxlar" id="yeniSifre2"></asp:TextBox>
                                                </div>
                                            </div>

                                            <div >
   
                                                 <asp:Button ID="changePassword" style="background-color: #d6e6f5; color: #012970; margin-left: 173px;" CssClass="buton" runat="server" Text="Change Password" OnClick="changePassword2_Click" />
                                            </div>
        ...
        <footer id="footer" class="footer" style="margin-top: 130px;">
