<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sayfa6.aspx.cs" Inherits="aspxliDeneme.Sayfa6" %>
          ...
          <div class="card" style="width: 800px;">
            <div class="card-body">
              <h5 class="card-title">Files</h5>
                 <div class="row mb-3" style="margin-left:688px;">
                
                  <div class="col-sm-10">
                    <asp:Button ID="Button2" style="background-color: #012970; color: white;" type="submit" class="btn btn-primary" runat="server" Text="New" OnClick="Button2_Click" />
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">File Name</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="fileNameText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">File Content Type</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="fileTypeText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">File Url</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="fileUrlText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:TextBox ID="fileUploadText" class="form-control" type="file" runat="server"></asp:TextBox>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:Button ID="Button1" type="submit" style="background-color: #012970; color: white;" class="btn btn-primary" runat="server" Text="Submit" OnClick="Button1_Click" />
                  </div>
                </div>
