<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sayfa9.aspx.cs" Inherits="aspxliDeneme.Sayfa9" %>
            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:TextBox ID="nameText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
    

                  <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Delivery Date</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="dateText" type="date" class="form-control" runat="server"></asp:TextBox>
                  </div>
                      
                </div>

                  <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Institution</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="instText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                   <asp:TextBox ID="departmentText" type="text" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
 
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <asp:Button ID="submitButon" type="submit" style="background-color: #012970;" class="btn btn-primary" runat="server" Text="Submit" OnClick="submitButon_Click" />
                  </div>
                </div>
